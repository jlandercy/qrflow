...
docReady(function() {
    ...
    function onScanSuccess(decodedText, decodedResult) {
        ...
        if (((decodedText !== lastResult) || formRepeatScanField.checked) && (t1 > t0 + parseFloat(formScanDelayField.value) * 1000.)) {
